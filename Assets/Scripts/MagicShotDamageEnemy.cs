...
public class MagicShotDamageEnemy : PickableItemWeapons
{
    ...
    public void Attack()
    {
        Collider2D[] hitResult = Physics2D.OverlapCircleAll(WeaponShotCloneSp.bounds.center, 0.6f, MainCharacterDamageLayer);
        if (hitResult == null)
            return;
